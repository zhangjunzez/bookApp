...
@interface MySavedTableViewCell()
...
@implementation MySavedTableViewCell
...
-(UIView *)bacView{
    if (!_bacView) {
        _bacView = [[UIView alloc]initWithFrame:CGRectMake(0, ScaleW(0), ScreenWidth , ScaleW(107))];
...
-(UIImageView *)headerImgView{
    if (!_headerImgView) {
        _headerImgView = [[UIImageView alloc]initWithFrame:CGRectMake(ScaleW(11), ScaleW(22) , ScaleW(47), ScaleW(63))];
...
-(UIButton *)addBtn{
    if (!_addBtn) {
        _addBtn = [WLTools allocButtonTitle:@"+" font:systemBoldFont(18) textColor:kMainTxtColor image:nil frame:CGRectMake(ScreenWidth - ScaleW(25), _moneyLabel.top + ScaleW(5), ScaleW(18), ScaleW(18)) sel:@selector(addAction:) taget:self];
