...
@interface DJRecodsListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DJRecodsListViewController
...
{
    DJListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"DJListTableViewCell"];
    if (!cell) {
        cell = [[DJListTableViewCell alloc]initWithStyle:(UITableViewCellStyleSubtitle) reuseIdentifier:@"DJListTableViewCell"];
