...
@interface BkMyConmendViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BkMyConmendViewController
...
{
    MycomendsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MycomendsTableViewCell"];
    if (!cell) {
        cell = [[MycomendsTableViewCell alloc]initWithStyle:(UITableViewCellStyleSubtitle) reuseIdentifier:@"MycomendsTableViewCell"];
