...
@interface BKJfsmViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BKJfsmViewController
...
{
    BkJfSmTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"BkJfSmTableViewCell"];
    if (!cell) {
        cell = [[BkJfSmTableViewCell alloc]initWithStyle:(UITableViewCellStyleSubtitle) reuseIdentifier:@"BkJfSmTableViewCell"];
