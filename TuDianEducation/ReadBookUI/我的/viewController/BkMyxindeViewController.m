...
@interface BkMyxindeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BkMyxindeViewController
...
{
    MyXindeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MyXindeTableViewCell"];
    if (!cell) {
        cell = [[MyXindeTableViewCell alloc]initWithStyle:(UITableViewCellStyleSubtitle) reuseIdentifier:@"MyXindeTableViewCell"];
