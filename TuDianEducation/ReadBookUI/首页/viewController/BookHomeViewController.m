...
-(UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - Height_NavBar-Height_TabBar) collectionViewLayout:layout];
        ...
        _collectionView.contentInset = UIEdgeInsetsMake(self.headerView.height + ScaleW(10), left, 0, left);
