...
@interface LXTuijianViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LXTuijianViewController
    ...
    [NetWorkTools postConJSONWithUrl:_requstUrl parameters:pamas success:^(id responseObject) {
        ...
        if (result.integerValue == 0) {
            for (NSDictionary *dic  in array) {
                LXMyTuijianModel *model = [[LXMyTuijianModel alloc]init];
