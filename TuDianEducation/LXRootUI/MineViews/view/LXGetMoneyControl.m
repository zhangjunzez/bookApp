...
@interface LXGetMoneyControl()<UIScrollViewDelegate>
...
@implementation LXGetMoneyControl
...
-(void)setBttonsArray:(NSArray *)bttonsArray
{
    ...
    for (int i = 0; i < _bttonsArray.count; i ++) {
        CGFloat titleWidth =_pamaWidth?: ScreenWidth/4.f;
...
-(void)setCurrentIndex:(NSInteger)currentIndex
{
    ...
    btn.selected = YES;
    btn.titleLabel.font = systemBoldFont(ScaleW(14));
