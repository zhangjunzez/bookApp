...
-(UILabel *)agreeLabel{
    if (!_agreeLabel) {
        _agreeLabel = [WLTools allocLabel:@"同意" font:systemFont(ScaleW(12)) textColor:kMainTxtColor frame:CGRectZero textAlignment:(NSTextAlignmentLeft)];
