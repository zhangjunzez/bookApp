...
-(void)viewConfig
{
    self.frame = CGRectMake(0, 0, ScaleW(50), ScaleW(52));
...
{
    if (!_messageLabel) {
        _messageLabel = [WLTools allocLabel:_message font:systemFont(ScaleW(12)) textColor:kMainTxtColor frame:CGRectMake(0, self.height - ScaleW(15), self.width, ScaleW(15)) textAlignment:(NSTextAlignmentCenter)];
    }
